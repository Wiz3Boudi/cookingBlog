...
router.use(categoryController.navLogoAndFooter);
...
router.post('/submit-recipe', upload.single('image'), validation.validaation, categoryController.submitRecipeOnPost);
